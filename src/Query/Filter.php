...
class Filter extends Property implements FilterInterface
{
	 ...
	 */
	public function __construct(string $property, $value, $operator = self::OPERATOR_EQUALS)
	{
...
//	}
	...
	{
		return [self::OPERATOR_EQUALS, self::OPERATOR_GT, self::OPERATOR_GTE, self::OPERATOR_LIKE, self::OPERATOR_LT, self::OPERATOR_LTE, self::OPERATOR_NOT_EQUALS, self::OPERATOR_IN, self::OPERATOR_NOT_IN];
	}
}
